  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="mockup-window border my-5 dark:border-white border-slate-700 transition duration-300 bg-indigo-400 dark:bg-slate-300 w-96 shadow-lg rounded-lg">
