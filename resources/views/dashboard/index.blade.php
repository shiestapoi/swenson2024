...
<body
    class="m-0 font-sans antialiased font-normal text-base leading-default bg-gray-50 text-slate-500 dark:text-white dark:bg-dark">
    <!-- sidenav  -->
    <aside
    ...
    <main class="ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen rounded-xl transition-all duration-200">
        ...
        <footer
            class="fixed bottom-0 inset-x-0 px-0 py-2 mx-6 transition-all shadow-none duration-250 ease-soft-in rounded-2xl lg:flex-nowrap lg:justify-start sticky backdrop-saturate-[200%] backdrop-blur-[30px] bg-[hsla(0,0%,100%,0.8)] shadow-blur">
            <div class="container mx-auto px-2 py-2 lg:px-8">
                <div class="flex flex-col lg:flex-row justify-between">
                    <p class="text-center text-sm text-gray-500 my-auto">&copy; {{ date('Y') }},
                        Created
                        with <i class="fa fa-heart text-red-500"></i> by
                        <a href="https://www.swenson.my.id" class="font-semibold text-gray-700"
                            target="_blank">Shoukosagiri</a>
                    </p>
                    <div class="flex items-center justify-center lg:justify-end">
                        <a href="https://github.com/shiestapoi"
                            class="text-gray-600 transition duration-300 dark:text-gray-300 hover:text-gray-500 dark:hover:text-gray-300"
                            aria-label="Github">
                        ...
                        <!-- Tambahkan tombol sosial media atau navigasi tambahan jika diperlukan -->
                    </div>
                </div>
            </div>
        </footer>
