...
<body class="bg-cyan-100 transition duration-300 dark:bg-dark">
    <aside
        class="top-0 left-0 flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 z-50">
        <div class="flex flex-col items-center mt-6 -mx-2">
            ...
            <li class="mt-3 flex items-center ">
                <label class="swap swap-rotate mr-5 darkmodeneon">
                    <input type="checkbox" id="dark-toggle">
                    <svg class="swap-on fill-current text-yellow-300 w-7 h-7" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
                    ...
                    <svg class="swap-off fill-current w-7 h-7 text-slate-500" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <label>
                    <a href="/logout"
                        class="mt-2 text-gray-500 transition-colors duration-200 rotate-180 dark:text-gray-400 rtl:rotate-0 hover:text-rose-500 dark:hover:text-rose-400">
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            <nav>
                ...
                <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
                    ...
                    <span class="mx-4 font-medium">Website</span>
                </a>
                ...
                <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
                    ...
                    <span class="mx-4 font-medium">Portofolio</span>
                </a>
